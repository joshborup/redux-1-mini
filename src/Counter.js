...
// - getState() => get tyhe state from the store
...
class Counter extends Component {
  ...
  componentDidMount() {
    // subcribe will listen for updates to the store and run a callback function after every dispatch
    store.subscribe(() => {
      // on each update, setState with the new store state
      this.setState({
        store: store.getState()
      });
    });
